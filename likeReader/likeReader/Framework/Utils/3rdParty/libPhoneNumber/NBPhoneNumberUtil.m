                 ...
                 keepRawInput:(BOOL)keepRawInput checkRegion:(BOOL)checkRegion error:(NSError**)error
{
    ...
    if (regionMetadata != nil) {
        ...
        // ----- 此处座机号码第一位0此处被修改,这里会匹配一个正则表达式
        //0371 66313111             +86 371  66313111
        //179110 0371 66313222      +86 0371 66313222
        //匹配0、179xx0、1(1|2|9)xxx0--猜测后边的17911 0、12580 0这是智能IP拨号，智能IP拨号时5位，最后的0是外地号码+0，这个匹配方式默认移除了区号前边的0
        //它导致输入座机号显示不完整037166313550--->显示为37166313550
        //如果修改该方法，又出现座机号码验证过不去的问题，因为验证也有一系列调用
