...
#import "TBI18nCountry.h"
#import "NBMetadataHelper.h"

@implementation TBI18nCountry
...
+(void) initAlpha2Dictionaries
{
    ...
    NBMetadataHelper* helper = [NBMetadataHelper sharedInstance];
    ...
    for (NSString* alpha2 in alpha2s)
    {
        TBLog(@"%@ %@ %@", alpha2, [alpha2ToCountryCodes valueForKey:alpha2], [alpha2ToCountryNames valueForKey:alpha2]);
    }
}
...
+(NSArray*)allAlpha2s
{
    ...
    {
        [TBI18nCountry initAlpha2Dictionaries];
    }
    return alpha2s;
}
...
{
    return [[TBI18nCountry alpha2ToCountryCodeDic] valueForKey:alpha2];
}

+(NSString*)countryNameFor: (NSString*)alpha2
{
    return [[TBI18nCountry alpha2ToCountryNameDic] valueForKey:alpha2];
}
